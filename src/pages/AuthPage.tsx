...
import {
  Eye, EyeOff, Mail, Lock, User, Sparkles, BookMarked, Zap, Star,
} from 'lucide-react';
            ...
            <motion.form key={mode}
              ...
              {mode === 'register' && (
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }}>
                  <label className="block text-xs font-bold text-foreground/70 mb-1.5 uppercase tracking-wide">Username</label>
                  <div className="relative">
